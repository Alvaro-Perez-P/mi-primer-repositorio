...
public class EjerciciosString6_2 {
    ...
    public static char codificar(char conjunto1[], char conjunto2[], char c) {
        ...
        if (conjunto1S.indexOf(Character.toLowerCase(c)) != -1) {
            return conjunto2[conjunto1S.toLowerCase().indexOf(Character.toLowerCase(c))];
        } else {
 ...
 /*
    ...
    //separo la frase y la vuelvo a unir poniendola en minuscula
